 ...
 */
public class WhetherInspectionController {
    ...
    @FXML
    public void onWhetherInspectionBtnClick(ActionEvent actionEvent) {
...
//                .body("{\"billingAddress\":{\"countryCode\":\"CHL\"},\"id\":1}")
    ...
    protected void onAreaQueryLogBtnClick() throws Exception{
        FXMLLoader fxmlLoader = new FXMLLoader(MainApplication.class.getResource("views/query/whether-inspection-querylog-popup.fxml"));
