...
public class AppleIDUtil
{
    ...
    public static HttpResponse token(HttpResponse res2){
        ...
        headers.put("X-Apple-ID-Session-Id",ListUtil.toList(res2.header("X-Apple-ID-Session-Id")));
        headers.put("scnt",ListUtil.toList(res2.header("scnt")));

        StringBuilder cookieBuilder = new StringBuilder();
        List<String> res1Cookies = res2.headerList("Set-Cookie");
        for(String item : res1Cookies){
            cookieBuilder.append(";").append(item);
        }
    ...
    public static HttpResponse manager(HttpResponse res3){
        ...
        headers.put("X-Apple-ID-Session-Id",ListUtil.toList(res3.header("X-Apple-ID-Session-Id")));
        headers.put("scnt",ListUtil.toList(res3.header("scnt")));

        StringBuilder cookieBuilder = new StringBuilder();
        List<String> resCookies = res3.headerList("Set-Cookie");
